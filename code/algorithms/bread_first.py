...
def generate_breath_first(protein = Protein("HHPHHHPHPHHPPHH")):
    '''
    ...
    # print so I can see what happens
    a = decide_best_chunk(protein)
    print(a)

    return (protein.path, protein.stability, protein.amino_positions)

def decide_best_chunk(protein):
    a = 2
    n = 4
    iterations = 100
    best_path = [None,1]
